          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className="max-w-[200px] max-h-[200px]">
                <img src={photo} alt="Doctor" className="w-full rounded-md" />
              </figure>
              ...
              <div>
                ...
                <div className="flex items-center gap-[6px] mt-2">
                  <span className="flex items-center gap-[6px] text-[14px] lg:text-[16px] font-semibold text-headingColor">
                    <img src={starIcon} alt="Star" className="w-4 h-4" /> {averageRating}
                  </span>
                  <span className="text-[14px] lg:text-[16px] text-textColor">
                    ({totalRating})
                  </span>
                </div>

                <p className="text__para text-[14px] leading-5 mt-3 lg:max-w-[390px] text-textColor">
                  {bio}
                </p>
              </div>
            </div>
            ...
            <div className="mt-[50px] border-b border-solid border-[#0066ff34]">
              <button
                ...
                className={`${
                  ...
                  py-2 px-5 mr-5 text-[16px] font-semibold`}
              >
                About
              </button>
