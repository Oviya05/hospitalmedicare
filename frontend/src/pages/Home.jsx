            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  We are dedicated to helping patients achieve better health and a
                  longer, happier life. Our compassionate care and advanced treatments
                  ensure you receive the support you need at every step of your wellness
                  journey.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className="py-[30px] px-5">
              <div className="flex items-center justify-center">
                <img src={icon01} alt="" className="ml-3" />
              </div>
              <div className="mt-[30px]">
            ...
            <div className="py-[30px] px-5">
              <div className="flex items-center justify-center">
                <img src={icon02} alt="" className="ml-3" />
              </div>
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-7 text-headingColor font-[700] text-center">
                  Find a Location
            ...
            <div className="py-[30px] px-5">
              <div className="flex items-center justify-center">
                <img src={icon03} alt="" className="ml-3" />
              </div>
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-7 text-headingColor font-[700] text-center">
                  Book Appointment
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              World-class for everyone.Our health System offers unmatched, expect health care.
            </p>
          </div>
...
<section>
  <div className="container">
    ...
    <div className="w-1/2  md:block"><img src={faqImg} alt="" />
    </div>
   <div className="w-full md:w-1/2">
  <h2 className="heading"> 
    Most question by over beloved patients
    </h2>
